...
import html
import requests
import zerotwobot.modules.sql.chatbot_sql as sql
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Luffy Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Luffy Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get('https://www.kukiapi.xyz/api/apikey=KUKITT1fWL4lR6/luffy/@YuitoSan/message='+Message)
